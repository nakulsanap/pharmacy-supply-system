...
public class MedicineStockController {
	...
	/**
	 * It will return the medicine stock information from the database. First it
	 * will validate the token and if the token is valid it will retutn the medicine
	 * stock information.
	 * 
	...
	@GetMapping("/ping")
	public String ping() {
		return "Medicine Stock service is up";
	}
	 ...
	 * @return This method returns the stock information based on the target ailment
	 ...
	 * @param token
	 * @param medicine
	 * @return stock count based on the type of medicine after validating token.
	 */
	 ...
	 * @param medicine
	 * @param count
	 * @return true if the stock value is updated by the count passed as an argument
	 *         and false if not.
	 */
